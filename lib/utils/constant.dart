...
const String packageName = 'com.news.kntv';
...
const String iosPackage = 'com.news.kntv';
const String iosLink = ''; //'your ios app link here';
const String appStoreId = '9876543120';

const String deepLinkUrlPrefix =
    'your_deeplink_url'; //example - https://xxx.page.link - Your dynamic link from Firebase
const String deeplinkURL =
    'your_domain_here'; //example - xxx.com - Your domain name
