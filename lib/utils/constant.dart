...
const String baseUrl = 'https://admin.kntvtelugu.com';
...
const String appName = 'KN TV';
const String packageName = 'com.news.kntv'; //Your Package name
const String androidLink = 'https://play.google.com/store/apps/details?id='; //DO NOT CHANGE

const String iosPackage = 'com.news.kntv'; //Your Package name
const String iosLink = ''; //Your Appstore App link here
