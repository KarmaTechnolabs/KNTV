...
class PushNotificationService {
    ...
    Future<dynamic> notificationHandler(RemoteMessage message) async {
      if (settingsRepo.getNotification()) {
        ...
        if (data.isNotEmpty &&
          ...
          var payload = data[NEWS_ID];
          String lanId = (data[LANGUAGE_ID] != null)
              ? data[LANGUAGE_ID].toString()
              : "1"; //1 = ENGLISH bydefault
  ...
  Future<void> _startForegroundService() async {
    const AndroidNotificationDetails androidNotificationDetails =
        AndroidNotificationDetails('com.news.kntv', 'news',
