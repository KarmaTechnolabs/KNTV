...
class NewsSubDetailsState extends State<NewsSubDetails> {
  ...
  Widget build(BuildContext context) {
    print("back press - from showMore? ${widget.fromShowMore}");
    return PopScope(
      // canPop: (widget.fromShowMore == true) ? false : true,
      onPopInvoked: /* (bool isTrue) => (widget.fromShowMore == true) ? Navigator.of(context).popUntil((route) => route.isFirst) : Navigator.pop(context) */ (bool isTrue) => onBackPress,
